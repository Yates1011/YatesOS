; ==================================================================
; System kernel pulled from Mikedev, will eventually need tweaking
; but it will do for now. 
; OS -- The Operating System kernel
; 
;
; This is loaded from the drive by BOOTLOAD, as KERNEL (.BIN files).
; The system call vectors, which start at a static point
; for programs to use are defined first. 
; Following that is the main kernel code and
...
; use a OS system call without having to know its exact position
...
os_main:
	...
	mov es, ax			; segments ever again, as OS and its programs
...
option_screen:
	...
	os_init_msg		db 'Welcome to YatesOS', 0
	os_version_msg		db 'Version ', MIKEOS_VER, 0

	dialog_string_1		db 'Thanks for trying out YatesOS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute YatesOS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of YatesOS, and', 0
